...
class OpenAITranslationService:
    """Translate dataset text columns into Vietnamese and write the result to CSV."""
    ...
    async def translate_dataset(
        ...
        output_path = self._resolve_output_path(
            ...
            explicit_output_path=request.output_path,
        )
    ...
    def _resolve_output_path(
        ...
        return resolved_input.with_name(f"{resolved_input.stem}.translated.vi.csv")
